  ...
  return (
    <>
      <Box sx={{ display: { xs: "none", md: "flex" } }}>
        ...
        <Button variant="contained" component ={Link} to= {"/register"} sx={{ mr: 1 , borderRadius: "20px", boxShadow: "none", backgroundColor: "#ff0000", color: "#fff", ':hover': {backgroundColor: "#B20000"}}}>
